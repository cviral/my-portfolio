export const METADATA = {
  title: "Portfolio | Viral Chonkar",
  description:
    "Viral Chonkar is a Software Developer from Mumbai (India), interested in crafting beautiful and functional applications.",
  siteUrl: "https://viralchonkar-frontend.web.app/",
  twitterHandle: "@viralchonkar",
};
...
export const TYPED_STRINGS = [
  "A unique Software Developer",
  "I create things to make work easy",
  "I create things to make business boom",
];

export const SOCIAL_LINKS = [
  {
    name: "mail",
    url: "mailto: cviral30@gmail.com",
  },
  {
    name: "linkedin",
    url: "https://www.linkedin.com/in/viral-chonkar-a41956bb/",
  },
  // {
  //   name: "github",
